    ...
    <div className="App">
      <header className="App-header">
        ...
        <div className="exercise-section">
          <Marquee speed={100} contents={["Morbi tincidunt tincidunt odio, ac tempor elit. Suspendisse condimentum turpis.", "Nam bibendum, odio sed tincidunt interdum, eros est semper lorem, vel tempor nunc neque vel.", "Aliquam nisi mi, mattis sit amet fermentum a."]} run={run} />
        </div>
        <div class="btns">
